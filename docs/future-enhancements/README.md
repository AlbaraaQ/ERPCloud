...
- ترحيل 0096 استُخدم لـ Bank Feeds و0097 لـOCR؛ التحسين التالي يبدأ من 0098
...
- **02 OCR مكتملة كشريحة mock للمراجعة والمسودة**: migration `0097_ocr_purchase_invoices.sql`، provider قابل للاستبدال، 4 مسارات أساسية، واجهة مراجعة، اختبار 6 حالات، وسكربت تحقق حي 10 نقاط. مزود OCR تجاري وقراءة pixels مؤجلان بقرار صريح داخل وثيقة 02.
- 03-10 لم تبدأ بعد ضمن هذه الخطة.
- P-C1..12 مكتملة
- P-M1..10 مكتملة
